...
insert  into `jasa`(`ID_JASA`,`NAMA_JASA`,`NO_TLP_JASA`,`BBM_JASA`,`EMAIL_JASA`,`ALAMAT_KAB_JASA`,`ALAMAT_KEC_JASA`,`INFO`,`PASSWORD_JASA`,`KOORDINAT_LONGITUDE`,`FOTO`,`KOORDINAT_LATITUDE`,`WAKTU_DAFTAR`,`RATING`) values 
(0,'sapi',NULL,NULL,NULL,NULL,NULL,NULL,'sapi',NULL,NULL,NULL,NULL,NULL);
